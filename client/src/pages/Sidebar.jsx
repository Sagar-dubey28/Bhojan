    ...
    <>
        ...
        <aside className="w-72 bg-base-100 shadow-xl border-r flex flex-col">
            ...
            <ul className="menu p-4 space-y-2">
                <li>
                <a className="flex items-center px-4 py-2 rounded-lg hover:bg-primary hover:text-primary-content transition-all" 
                ...
                <li>
                <a className="flex items-center px-4 py-2 rounded-lg hover:bg-secondary hover:text-secondary-content transition-all"
            ...
            <li className="mt-1 border-t pt-4">
                <button className="flex items-center gap-3 text-error hover:bg-error/10 hover:text-error rounded-lg px-4  transition-all">
